...
ruby_video1 = Video.create(language_id: ruby.id, publisher: "Tony", title: "Intro to Object Oriented Ruby", key: "SPWq1BR4OQw", description: "A video of a lead instructor at flatiron teaching his promising students what object-oriented ruby is.")
ruby_video11 = Video.create(language_id: ruby.id, publisher: "Derek Banas", title: "Ruby Programming", key: "Dji9ALCgfpM", description: "Get the Code Here : http://goo.gl/1QMv0a
